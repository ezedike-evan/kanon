  ...
  return (
    <div className="min-h-screen bg-void text-bone font-mono">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-void/80 backdrop-blur-md border-b border-hairline">
        ...
        <Link href="/home">
          <SpecularButton size="sm" className="uppercase tracking-widest font-bold text-xs" tint="#D4A017" tintOpacity={0.2} lineColor="#D4A017">
            Launch App
          </SpecularButton>
        </Link>
      </header>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 text-center pt-20">
        ...
        <div className="relative z-10 max-w-4xl mt-12">
          ...
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-center">
            <Link href="/home">
              <SpecularButton size="lg" className="uppercase tracking-widest font-bold text-sm" tint="#D4A017" tintOpacity={0.15} lineColor="#D4A017">
                Compile Strategy
              </SpecularButton>
            </Link>
            <Link href="#thesis">
